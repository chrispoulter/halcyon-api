    ...
    )
    {
        ...
        else
        {
            builder.Services.AddKeyedScoped(
                serviceKey,
                (sp, key) => CreateMailKitClientFactory(sp)
            );
        }
        ...
        if (settings.DisableTracing is false)
        {
            builder
                ...
                .WithTracing(traceBuilder =>
                    traceBuilder.AddSource(MailKit.Telemetry.SmtpClient.ActivitySourceName)
                );
        }
        ...
        if (settings.DisableMetrics is false)
        {
            ...
            builder
                ...
                .WithMetrics(metricsBuilder =>
                    metricsBuilder.AddMeter(MailKit.Telemetry.SmtpClient.MeterName)
                );
        }
    }
}
